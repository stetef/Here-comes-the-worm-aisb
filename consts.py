...
WORM_DB_DIR = 'Data/embedded_data/with_worm/'
BENIGN_DB_DIR = 'Data/embedded_data/without_worm/'
JUST_WORM_DIR = 'Data/embedded_data/vectorized_WORM/'
